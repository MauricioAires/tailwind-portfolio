  ...
  return (
    <>
      ...
      <div
        ...
        className="fixed bottom-0 left-0 z-20 flex w-min items-center  px-2"
      >
        <ul className="flex flex-col items-center bg-airs-navy after:mt-8 after:h-24 after:w-px after:bg-airs-light-slate">
          <li className="flex items-center">
            <a
              ...
              className="px-2.4 py-4 transition-all duration-300 hover:-translate-y-1  hover:text-airs-green md:px-6"
            >
          ...
          <li className="flex items-center">
            <a
              ...
              className="px-2.4 py-4 transition-all duration-300 hover:-translate-y-1  hover:text-airs-green md:px-6"
            >
              <CodepenIcon className="h-5 w-5 md:h-6 md:w-6" />
            </a>
          </li>
          <li className="flex items-center">
            <a
      ...
      <div
        aria-orientation="vertical"
        className="fixed bottom-0 right-0 z-20 flex w-min items-center px-2 "
      >
        <ul className="flex flex-col items-center bg-airs-navy after:mt-8 after:h-24 after:w-px after:bg-airs-light-slate">
          <li className="flex items-center">
            <a
              ...
              className="px-2.4 py-4 text-sm tracking-widest transition-all duration-300  hover:-translate-y-2 hover:text-airs-green md:px-6"
            >
      ...
      <div className="max-w-[1600px]"></div>
        ...
        <div className="flex flex-col items-center gap-20  lg:flex-row lg:items-start">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-lg ">
              ...
              novas oportunidades para aprender e crescer. Tenho um forte senso
              crítico e sou capaz de identificar e resolver problemas de forma
              eficaz. Sou também um comunicador eficaz, tanto oral quanto
              escrito.
            </p>
      ...
      <section id="projetos" className="mt-40 px-10  pt-24 md:px-24">
        <h2 className="mb-10 text-3xl font-bold text-airs-lightest-slate">
      ...
      <footer className="flex h-20 items-center justify-center hover:text-airs-green">
        <span>Designed & Built by Mauricio Aires</span>
      </footer>
    </>
  )
}
